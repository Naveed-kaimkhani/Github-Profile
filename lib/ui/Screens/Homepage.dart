          ...
          child: Column(
            children: [
              ...
              Container(
                height: 120,
                width: 120,
                child: Image.network("https://icon-library.com/images/github-icon-white/github-icon-white-6.jpg")),
              SizedBox(height: 50,),
              Padding(
                ...
                child: TextFormField(
                  controller: _controller,
                            ...
                            hintStyle: TextStyle(color: Colors.white),
                              labelText: "Enter Username",labelStyle: TextStyle(color: Colors.white),
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  child: Text("Get my protfile",style: TextStyle(fontSize: 17),)),
              )
            ],
          ),
        ),
