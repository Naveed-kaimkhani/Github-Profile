          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 10,),
                Text(userinfo.followers.toString(),style: TextStyle(color:Colors.white),),
                SizedBox(width: 10,),
                Text(userinfo.following.toString(),style: TextStyle(color:Colors.white),),
              ],
            ),
          ),
          SizedBox(height: 20,),
            ...
            child: GridView.count(
              ...
              children: reposInfo.map((item) => GestureDetector(
                onTap: (){
                  ...
                  print(item!.html_url);
                  print("heeee");
                  Navigator.of(context).pushNamed(AppRoutes.Repo_webview,arguments: item!.html_url);
                  print("haaaa");
                  },
